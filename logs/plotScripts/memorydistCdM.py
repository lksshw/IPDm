...
cdmMem_path = os.path.join(logs_dir, "CDMLogs/checkpoints/memorySizeList-vs-time.pkl")

cdmMemScr_path = os.path.join(logs_dir, "CDMLogs/checkpoints/memory_score_map.pkl")
...
fig.tight_layout()
plt.savefig(os.path.join(curr_path, "figs/memorysize.png"), dpi=300)
plt.show()
